...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    debugPrint("came to dashboard12");
    return WillPopScope(
      onWillPop: () async {
        if(_pageIndex != 0) {
          _setPage(0);
      ...
      child: Scaffold(
        ...
        floatingActionButton: //!GetPlatform.isMobile ? null :
        ...
        floatingActionButtonLocation: //!GetPlatform.isMobile ? null :
        FloatingActionButtonLocation.centerDocked,

        bottomNavigationBar: //!GetPlatform.isMobile ? const SizedBox() :
        BottomAppBar(
          elevation: 5,
          notchMargin: 5,
