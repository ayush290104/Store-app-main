  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<DeliveryManController>(builder: (dmController) {
        return dmController.deliveryManList == null?const Center(child: CircularProgressIndicator()): dmController.deliveryManList!.isNotEmpty ?
        ListView.builder(
            ...
            return InkWell(
              ...
              child: Column(children: [
                ...
                Row(children: [
                  ...
                  IconButton(
                    onPressed: (){
                      debugPrint("value of vehicle is ${deliveryMan.vehicleId}");
