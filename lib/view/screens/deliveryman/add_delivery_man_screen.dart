...
class _AddDeliveryManScreenState extends State<AddDeliveryManScreen> {
  ...
  void initState() {
    ...
    if(widget.deliveryMan!=null){
      debugPrint("delivery man ki details is ${widget.deliveryMan!.vehicleId}");
    }
    ...
    if(_update) {
      ...
      _vehicleController.text = _deliveryMan!.vehicleId!;
          ...
          Expanded(child: SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              MyTextField(
                ...
                nextFocus: _vehicleNode,
                inputType: TextInputType.emailAddress,
              ),
              const SizedBox(height: Dimensions.paddingSizeLarge),
              MyTextField(
                hintText: 'Vehicle-id'.tr,
  ...
  void _addDeliveryMan(DeliveryManController dmController) async {
    debugPrint("response this time is ${Get.find<AuthController>().getUserToken()}");
    String fName = _fNameController.text.trim();
     String vehicleid = _vehicleController.text.trim();
    ...
    if(fName.isEmpty) {
      ...
      showCustomSnackBar('enter_vehicle_id_first'.tr);
      ...
      _deliveryMan!.vehicleId= vehicleid;
